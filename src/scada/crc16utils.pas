...
const
  //CRC-8/MAXIM (Dallas/1-Wire): poly $31 REFLETIDO ($8C), init $00, refin e
  //refout verdadeiros, xorout $00 - valor de conferencia $A1 para "123456789".
  //A tabela anterior era a do mesmo polinomio SEM refletir, e por isso o
  //resultado nao batia com o padrao catalogado.
  //
  //CRC-8/MAXIM (Dallas/1-Wire): poly $31 REFLECTED ($8C), init $00, refin and
  //refout true, xorout $00 - check value $A1 for "123456789". The previous
  //table was the same polynomial NOT reflected, which is why the result did
  //not match the catalogued standard.
